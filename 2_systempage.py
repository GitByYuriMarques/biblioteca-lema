...
from tkinter import messagebox  # Importando messagebox para exibir caixas de diálogo
from PIL import Image, ImageTk  # Importando os módulos Image e ImageTk do Pillow para trabalhar com imagens
import importlib.util  # Importando o módulo importlib.util para carregar um módulo Python de forma dinâmica
...
def abrir_janela_sistema():
    ...
    janela_sistema = tk.Toplevel()  # tkToplevel quer dizer que é uma segunda janela
    ...
    # Adicionando botão de busca a janela
